...
public class LayersTest {
    ...
    public void testAllConstructors() {
        ...
        // create neural network with number of layers, initial weights per input, biases for each neuron, and initial inputs
        DenseLayers layers5C = new DenseLayers(4, new int[]{3,5,6,7}, weights, biases, inputs,DEFAULT_ACTIVATION_FUNCTIONS.LINEAR_ACTIVATION_FUNCTION);
        layers5C.getLayerAt(1).setActivationFunction(DEFAULT_ACTIVATION_FUNCTIONS.RELU_ACTIVATION_FUNCTION);
