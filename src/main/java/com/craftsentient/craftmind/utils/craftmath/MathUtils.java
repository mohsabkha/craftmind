...
public class MathUtils {
    ...
    public static Double dotProduct(Object a, Object b) {
        if (isDoubleList(a) && isDoubleList(b)) {
            ...
            throw new IllegalArgumentException("Input must be arrays of the same dimension, and if they are, they are not arrayLists!");
        }
    }
    ...
    public static double arrayDotProduct(double[]a, double[]b) {
        ...
        if(a.length != b.length) {
            throw new IllegalArgumentException("Dimensions mismatch! a.length=" + a.length + ", b.length=" + b.length);
        }
        AtomicReference<Double> sum = new AtomicReference<>((double) 0);
    ...
    public static Object matrixDotProduct(Object a, Object b) {
        if(isDoubleList(a) && isDoubleList(b)) {
            ...
            if(ElementOfFirstArrayIsDoubleArrayAndBothAreOfSameSize(a,b)) {
                ...
                throw new ArithmeticException("ERR2: a and b must be of equal size");
            }
            ...
            if(ElementOfFirstArrayIsDoubleArrayAndBothAreOfSameSize(b,a)) {
                ...
                throw new ArithmeticException("ERR3: a and b must be of equal size");
            }
            ...
            if(ElementsOfBothArraysAreDoubleArraysAndBothAreOfProperSize(a,b)) {
                ...
                throw new ArithmeticException("ERR4: a and b must be of equal size");
            }
        } else {
            throw new ArithmeticException("ERR5: a and b must be of equal size");
        }
    }
    ...
    public static ArrayList<Double> addVectors(ArrayList<Double> a, ArrayList<Double> b) throws ArithmeticException {
        if(a.size() != b.size()) {
            throw new ArithmeticException("vectors should be of same size");
        }
        if(a.size() == 0) {
            throw new ArithmeticException("vector sizes should not be zero");
        }
    ...
    public static double[] multiplyArrays(double[] a, double[] b) {
        ...
        if(a.length == 0) {
            throw new ArithmeticException("vector size should not be zero");
        }
        double[] vectorProduct = new double[a.length];
        IntStream.range(0, a.length).parallel().forEachOrdered( i -> { vectorProduct[i] = (a[i] * b[i]); });
    ...
    public static double accuracySum(double[] trueValues, int[] predictedValues) {
        if(trueValues.length != predictedValues.length) {
            throw new IllegalArgumentException("Number of true values is not equal to number of predicted values");
        }
        ...
        IntStream.range(0, trueValues.length).parallel().forEachOrdered(i -> {
            if(trueValues[i] == predictedValues[i]) {
                totalCorrect.getAndUpdate(v -> v + 1);
            }
        });
    ...
    public static double accuracySum(int[][] trueHotValues, int[] predictedValues) {
        if(trueHotValues.length != predictedValues.length) {
            throw new IllegalArgumentException("Number of true values is not equal to number of predicted values");
        }
        AtomicReference<Double> totalCorrect = new AtomicReference<>((double)0);
